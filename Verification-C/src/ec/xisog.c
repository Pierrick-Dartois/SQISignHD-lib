...
xisog_3(ec_kps_t *kps, ec_point_t *B24, const ec_point_t P)
{
    ...
    fp2_mul(B24->A,&r3,&r5); // A24=r3.r5=(x+z)(3x-z)^3
    ...
    fp2_sub(B24->C,&r5,B24->A); // C24=r5-A24=-16xz^3. OK
}

// (2d+1)-isogeny with kernel generated by P. Optimized formulas found in https://eprint.iacr.org/2017/504.pdf (Algorithm 2)
void
xisog_odd(ec_kps_t *kps, ec_point_t *B24, const ec_point_t P, ec_point_t A24, unsigned int d)
{
    const unsigned int cd=d;
    ec_point_t kpsK[cd];
