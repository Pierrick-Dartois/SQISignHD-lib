...
#define KLPT_signing_klpt_length 1134
...
#define KLPT_keygen_length 756
#define KLPT_keygen_num_gamma_trial 64
#define KLPT_eichler_smallnorm_bitsize 376
...
#define SQISIGN_signing_total_length 1134
#define SQISIGN_signing_length 9
