...
const ibz_t FIXED_DEGREE_SK_COM = {{._mp_alloc = 0, ._mp_size = 48, ._mp_d = (mp_limb_t[]) {0xfcc7,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff}}};
#elif 8*DIGIT_LEN == 32
const uint64_t TORSION_PLUS_EVEN_POWER = 0x178;
const uint64_t TORSION_ODD_PRIMES[6] = {0x5, 0xd, 0x3, 0xb, 0x13, 0x2f};
const uint64_t TORSION_ODD_POWERS[6] = {0x1, 0x1, 0x1, 0x2, 0x1, 0x1};
...
const ibz_t FIXED_DEGREE_SK_COM = {{._mp_alloc = 0, ._mp_size = 24, ._mp_d = (mp_limb_t[]) {0xfffffcc7,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff}}};
#elif 8*DIGIT_LEN == 64
const uint64_t TORSION_PLUS_EVEN_POWER = 0x178;
const uint64_t TORSION_ODD_PRIMES[6] = {0x5, 0xd, 0x3, 0xb, 0x13, 0x2f};
const uint64_t TORSION_ODD_POWERS[6] = {0x1, 0x1, 0x1, 0x2, 0x1, 0x1};
...
const ibz_t FIXED_DEGREE_SK_COM = {{._mp_alloc = 0, ._mp_size = 12, ._mp_d = (mp_limb_t[]) {0xfffffffffffffcc7,0xffffffffffffffff,0xffffffffffffffff,0xffffffffffffffff,0xffffffffffffffff,0xffffffffffffffff,0xffffffffffffffff,0xffffffffffffffff,0xffffffffffffffff,0xffffffffffffffff,0xffffffffffffffff,0xffffffffffffffff}}};
#endif
