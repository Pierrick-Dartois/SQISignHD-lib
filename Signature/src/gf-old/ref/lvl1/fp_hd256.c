/* Autogenerated: '/Users/wesolowskibenjamin/Git/fiat-crypto/src/ExtractionOCaml/word_by_word_montgomery' p256 64 '2^126*3^78*13 - 1' */
/* curve description: p256 */
/* machine_wordsize = 64 (from "64") */
/* requested operations: (all) */
/* m = 0x2827baebd5c8e56ea4382e87ff9dc5893fffffffffffffffffffffffffffffff (from "2^126*3^78*13 - 1") */
/*                                                                    */
 ...
 *   out2: [0x0 ~> 0x1]
 */
void fiat_p256_addcarryx_u64(uint64_t* out1, fiat_p256_uint1* out2, fiat_p256_uint1 arg1, uint64_t arg2, uint64_t arg3) {
 ...
 *   out2: [0x0 ~> 0x1]
 */
void fiat_p256_subborrowx_u64(uint64_t* out1, fiat_p256_uint1* out2, fiat_p256_uint1 arg1, uint64_t arg2, uint64_t arg3) {
  fiat_p256_int128 x1;
  fiat_p256_int1 x2;
  uint64_t x3;
...
void fiat_p256_mul(fiat_p256_montgomery_domain_field_element out1, const fiat_p256_montgomery_domain_field_element arg1, const fiat_p256_montgomery_domain_field_element arg2) {
  ...
  fiat_p256_subborrowx_u64(&x198, &x199, 0x0, x189, UINT64_C(0xffffffffffffffff));
  fiat_p256_subborrowx_u64(&x200, &x201, x199, x191, UINT64_C(0x3fffffffffffffff));
  fiat_p256_subborrowx_u64(&x202, &x203, x201, x193, UINT64_C(0xa4382e87ff9dc589));
  fiat_p256_subborrowx_u64(&x204, &x205, x203, x195, UINT64_C(0x2827baebd5c8e56e));
...
void fiat_p256_sub(fiat_p256_montgomery_domain_field_element out1, const fiat_p256_montgomery_domain_field_element arg1, const fiat_p256_montgomery_domain_field_element arg2) {
  ...
  fiat_p256_addcarryx_u64(&x12, &x13, x11, x3, (x9 & UINT64_C(0x3fffffffffffffff)));
  fiat_p256_addcarryx_u64(&x14, &x15, x13, x5, (x9 & UINT64_C(0xa4382e87ff9dc589)));
  fiat_p256_addcarryx_u64(&x16, &x17, x15, x7, (x9 & UINT64_C(0x2827baebd5c8e56e)));
  out1[0] = x10;
  out1[1] = x12;
  out1[2] = x14;
  out1[3] = x16;
...
void fiat_p256_from_montgomery(fiat_p256_non_montgomery_domain_field_element out1, const fiat_p256_montgomery_domain_field_element arg1) {
  ...
  x108 = (x107 + (x99 + x87));
  fiat_p256_subborrowx_u64(&x109, &x110, 0x0, x102, UINT64_C(0xffffffffffffffff));
  fiat_p256_subborrowx_u64(&x111, &x112, x110, x104, UINT64_C(0x3fffffffffffffff));
  fiat_p256_subborrowx_u64(&x113, &x114, x112, x106, UINT64_C(0xa4382e87ff9dc589));
  fiat_p256_subborrowx_u64(&x115, &x116, x114, x108, UINT64_C(0x2827baebd5c8e56e));
...
void fiat_p256_to_montgomery(fiat_p256_montgomery_domain_field_element out1, const fiat_p256_non_montgomery_domain_field_element arg1) {
  ...
  fiat_p256_addcarryx_u64(&x61, &x62, x60, ((x40 + (x18 + x6)) + (x32 + x20)), x53);
  ...
  fiat_p256_addcarryx_u64(&x105, &x106, x104, ((x84 + (x62 + (x54 + x42))) + (x76 + x64)), x97);
  ...
  fiat_p256_addcarryx_u64(&x149, &x150, x148, ((x128 + (x106 + (x98 + x86))) + (x120 + x108)), x141);
  ...
  fiat_p256_subborrowx_u64(&x174, &x175, 0x0, x167, UINT64_C(0xffffffffffffffff));
  fiat_p256_subborrowx_u64(&x176, &x177, x175, x169, UINT64_C(0x3fffffffffffffff));
  fiat_p256_subborrowx_u64(&x178, &x179, x177, x171, UINT64_C(0xa4382e87ff9dc589));
  fiat_p256_subborrowx_u64(&x180, &x181, x179, x173, UINT64_C(0x2827baebd5c8e56e));
...
void fiat_p256_divstep(uint64_t* out1, uint64_t out2[5], uint64_t out3[5], uint64_t out4[4], uint64_t out5[4], uint64_t arg1, const uint64_t arg2[5], const uint64_t arg3[5], const uint64_t arg4[4], const uint64_t arg5[4]) {
  ...
  fiat_p256_addcarryx_u64(&x64, &x65, x63, x55, (x61 & UINT64_C(0x3fffffffffffffff)));
  fiat_p256_addcarryx_u64(&x66, &x67, x65, x57, (x61 & UINT64_C(0xa4382e87ff9dc589)));
  fiat_p256_addcarryx_u64(&x68, &x69, x67, x59, (x61 & UINT64_C(0x2827baebd5c8e56e)));
  ...
  fiat_p256_subborrowx_u64(&x104, &x105, x103, x96, UINT64_C(0x3fffffffffffffff));
  fiat_p256_subborrowx_u64(&x106, &x107, x105, x98, UINT64_C(0xa4382e87ff9dc589));
  fiat_p256_subborrowx_u64(&x108, &x109, x107, x100, UINT64_C(0x2827baebd5c8e56e));
